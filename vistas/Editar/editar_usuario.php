                ...
                <div class="shadow-lg p-3 mb-5 mt-4 bg-body rounded">
                    ...
                    <form action="../../variables/variables_registro_usuarios.php?id_editar_usuario=<?php echo $_GET['id_editar_usuario']; ?>" method="post" class="row g-3 needs-validation" novalidate>
                        ...
                        <div class="col-md-4">
                            ...
                            <input class="form-control" type="number" placeholder="Ingrese su cédula" id="txtIde" name="ide" value=<?php echo $filas['identificacion']; ?> required />
                        ...
                        <div class="col-md-4">
                            ...
                            <input class="form-control" type="text" placeholder="Ingrese su dirección" id="txtDir" name="address" value=<?php echo $filas['direccion']; ?> required />
                        ...
                        <div class="col-md-4">
                            ...
                            <input class="form-control" type="number" placeholder="Ingrese su teléfono" id="txtTel" name="phone" value=<?php echo $filas['telefono']; ?> required />
                        ...
                        <div class="col-md-4">
                            ...
                            <input class="form-control" type="password" placeholder="Ingrese una contraseña" id="txtPass" name="pass" value=<?php echo $filas['clave']; ?> required />
                            <div class="valid-feedback">Contraseña ok!</div>
                            <div class="invalid-feedback">Por favor ingrese una contraseña.</div>
                        </div>
                        <div class="col-md-4">
                            <label class="form-label" for="txtCod">Código de usuario</label>
                            <input class="form-control" type="text" placeholder="Ingrese un código" id="txtCod" name="user_code" value=<?php echo $filas['codigo_usuario']; ?> required />
