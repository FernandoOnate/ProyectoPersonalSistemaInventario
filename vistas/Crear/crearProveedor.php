                ...
                <div class="shadow-lg p-3 mb-5 mt-4 bg-body rounded">
                    ...
                    <form action="../../variables/variables_registro_proveedores.php" $accion; method="post" class="row g-3 needs-validation" novalidate>
                        ...
                        <div class="col-md-4">
                            ...
                            <input class="form-control" type="text" placeholder="Ingrese la dirección" id="txtDir" name="dir" required />
                        ...
                        <div class="col-md-4">
                            ...
                            <input class="form-control" type="number" placeholder="Ingrese el teléfono" id="txtTel" name="tel" required />
